...
abstract class Game extends Applet implements Runnable, KeyListener,
    ...
    abstract void gameDrawBackground();
    ...
    abstract boolean spriteCollision(AnimatedSprite spr1, AnimatedSprite spr2);
 ...
 ********************************************************************/
    public void init() {
        ...
        //creae the internal sprite list
 ...
 ********************************************************************/
    public void update(Graphics g) {
        ...
        /*if (!gamePaused())*/ {  //removed for tetris
            drawSprites();
        }
        //this method implemented by sub-class
        gameRefreshScreen();
 ...
 ********************************************************************/
    public void run() {
        ...
        while (t == gameloop) {
            ...
            if(!gamePaused()) {
                updateSprites();
                //testCollisions(); *********************************// removed to better suit tetris
            }
 ...
 ********************************************************************/
    protected void testCollisions() {
        //iterete through the sprite list, test each sprite against
