...
public class Sprite extends Object {
    ...
    //preform affine transformations
    ...
    //generic sprite state variable (alive, dead, collided, ext.)
    ...
    //play
    public boolean play() {return play;}
    public void setPlay(boolean ply) {this.play = ply;}
    //sprite grid
    public Point2D grid() {return grid;}
    public void setGrid(Point2D grid) {this.grid = grid;}
    ...
    public Point2D center() {
        return (new Point2D((int)entity.getCenterX(),(int)entity.getCenterY()));
    }
    ...
    public int setLifeage() {return _lifeage;}
